...
function addToPanel() {
    ...
    if (cantidad >= 5) {
        alert("No puede ingresar más de 5 imágenes");
    }else{
//Variables a usar
...
input.type="";
input.value="";
spanSimbolo2.appendChild(document.createTextNode(""));
...
function Enviar(){
    ...
    var cantidad=lista_carro.children.length-1;
    if(cantidad == 0){
        alert("No ha ingresando niguna foto");
    }else{
...
location.href='lista-productos MODIFICACION.html';
}
